...
const HomePage = () => {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      <aside className="fixed inset-y-0 left-0 hidden w-20 flex-col space-y-6 border-r bg-background sm:flex z-50">
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
        <Sheet>
          ...
          <SheetContent side="left" className="sm:max-w-xs flex flex-col">
            <nav className="grid gap-6 text-lg font-medium mt-6 flex-grow">
              <Link
                href="#"
        ...
        <div className="flex flex-wrap items-center justify-between w-full sm:mt-5">
          ...
          <div className="flex items-center gap-4 ml-0 sm:ml-20 min-w-0">
            ...
            />
            <h1
              className="text-lg sm:text-4xl font-semibold truncate max-w-[calc(100vw-96px)] sm:max-w-none"
