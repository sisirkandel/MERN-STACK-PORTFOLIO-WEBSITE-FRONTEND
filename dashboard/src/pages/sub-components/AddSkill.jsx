...
const AddSkill = () => {
  ...
  const handleProficiencyChange = (e) => {
    ...
    setProficiency(numValue);
  };

  const handleAddNewSkill = (e) => {
    e.preventDefault();

    let finalProficiency = Number(proficiency);
    if (isNaN(finalProficiency) || finalProficiency < 1) {
      toast.error("Please enter a valid proficiency between 1 and 100");
      return;
    }

    if (finalProficiency > 100) finalProficiency = 100;

    const formData = new FormData();
    formData.append("title", title);
    formData.append("proficiency", finalProficiency);
      ...
      >
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 dark:border-gray-100/10 pb-12">
            <h2 className="font-semibold leading-7 text-gray-900 dark:text-white text-3xl text-center">
              ADD A NEW SKILL
            </h2>
                ...
                <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 dark:border-gray-100/25 px-6 py-10">
                  <div className="text-center">
                    ...
                    <div className="mt-4 flex text-sm leading-6 text-gray-600 dark:text-gray-400">
                      <label
                        htmlFor="file-upload"
                        className="relative cursor-pointer rounded-md bg-white dark:bg-gray-800 font-semibold text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2"
                      >
