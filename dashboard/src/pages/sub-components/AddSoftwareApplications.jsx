      ...
      >
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 dark:border-gray-300/10 pb-12">
            <h2 className="font-semibold text-3xl text-center text-gray-900 dark:text-gray-100">
            ...
            <div className="mt-10 flex flex-col gap-5">
              ...
              <div className="w-full col-span-full">
                ...
                <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 dark:border-gray-500 px-6 py-10">
                  <div className="text-center">
                    ...
                    <div className="mt-4 flex text-sm leading-6 text-gray-600 dark:text-gray-400">
                      <label
                        htmlFor="file-upload"
                        className="relative cursor-pointer rounded-md bg-white dark:bg-gray-800 font-semibold text-indigo-600 dark:text-indigo-400 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500"
                      >
