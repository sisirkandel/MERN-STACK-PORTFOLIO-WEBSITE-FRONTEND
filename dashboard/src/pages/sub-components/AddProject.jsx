        ...
        >
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 dark:border-gray-700 pb-12">
              <h2 className="font-semibold leading-7 text-gray-900 dark:text-gray-100 text-3xl">
                ADD NEW PROJECT
              </h2>
              <div className="mt-10 flex flex-col gap-5">
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <input
                        type="text"
...
<div className="w-full sm:col-span-4">
  ...
  <div className="mt-2">
    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700
                    focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
      <Select
        value={
          ["Full Stack", "Mern", "Mean", "Next.JS", "React.JS"].includes(stack)
            ? stack
            : "Others"
        }
        onValueChange={(selectedValue) => {
          if (selectedValue === "Others") {
            setStack(""); // Clear stack to allow custom input
          } else {
    ...
    <div className="mt-3">
      <input
        ...
        className="block w-full rounded-md border border-gray-300 bg-transparent
                   py-1.5 px-2 text-gray-900 placeholder:text-gray-400
      ...
      />
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="relative flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                      <input
                        type="text"
                      ...
                      />
                      <Link className="absolute w-5 h-5 left-1 top-2 text-gray-400 dark:text-gray-300" />
                    </div>
                  </div>
                </div>
