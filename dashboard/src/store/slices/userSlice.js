...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    ...
    console.log("LOGIN SUCCESS - data:", data); // ✅ check this
    dispatch(userSlice.actions.loginSuccess(data.user));
    dispatch(userSlice.actions.clearAllErrors());
  } catch (error) {
    console.log("LOGIN ERROR - error object:", error); // ✅ check this
    console.log("LOGIN ERROR - error.response:", error.response); // May be undefined
    dispatch(
...
export const updateProfile = (formData) => async (dispatch) => {
  ...
  try {
    ...
    // After successful update, refetch updated user data:
    dispatch(getUser()); // <-- important: refresh user in Redux
